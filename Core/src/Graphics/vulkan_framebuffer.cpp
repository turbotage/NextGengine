...
bool ng::graphics::VulkanFramebufferAttachment::hasStencil()
{
	std::vector<VkFormat> formats = {
		VK_FORMAT_S8_UINT,
		VK_FORMAT_D16_UNORM_S8_UINT,
...
bool ng::graphics::VulkanFramebufferAttachment::isDepthStencil()
{
	return(hasDepth() || hasStencil());
}

ng::graphics::VulkanFramebuffer::VulkanFramebuffer(VulkanDevice * vulkanDevice)
{
	assert(vulkanDevice);
	this->vulkanDevice = vulkanDevice;
}

ng::graphics::VulkanFramebuffer::~VulkanFramebuffer()
{
	assert(vulkanDevice);
...
uint32 ng::graphics::VulkanFramebuffer::addAttachment(VulkanAttachmentCreateInfo attachmentCreateInfo)
{
...
VkResult ng::graphics::VulkanFramebuffer::createSampler(VkFilter magFilter, VkFilter minFilter, VkSamplerAddressMode addressMode)
{
...
VkResult ng::graphics::VulkanFramebuffer::createRenderPass()
{
