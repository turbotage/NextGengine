...
ng::vulkan::VulkanApplication::VulkanApplication() 
{
	ng::vulkan::debug::setValidationLayers(appSettings.validation);



}

void ng::vulkan::VulkanApplication::createPhysicalDevices()
{
...
void ng::vulkan::VulkanApplication::init()
{
	window.init(800, 600, appSettings.appWindowName);
...
void ng::vulkan::VulkanApplication::run()
{

}

void ng::vulkan::VulkanApplication::cleanup()
{
