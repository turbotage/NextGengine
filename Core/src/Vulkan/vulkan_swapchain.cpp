...
ng::vulkan::VulkanSwapchain::VulkanSwapchain()
{
}

ng::vulkan::VulkanSwapchain::VulkanSwapchain(VulkanSwapchainCreateInfo createInfo)
...
void ng::vulkan::VulkanSwapchain::init(VulkanSwapchainCreateInfo createInfo)
{
	instance = createInfo.instance;
	vulkanDevice = createInfo.vulkanDevice;
}

void ng::vulkan::VulkanSwapchain::createSurface(GLFWwindow *glfwWindowPtr)
{
	VULKAN_CHECK_RESULT(glfwCreateWindowSurface(instance, glfwWindowPtr, nullptr, &surface));
}

void ng::vulkan::VulkanSwapchain::createSwapchain(uint32* width, uint32* height, bool vsync)
{
...
VkResult ng::vulkan::VulkanSwapchain::acquireNextImage(VkSemaphore presentCompleteSemaphore, uint32 * imageIndex)
{
...
VkResult ng::vulkan::VulkanSwapchain::queuePresent(VkQueue queue, uint32 imageIndex, VkSemaphore waitSemaphore)
{
...
void ng::vulkan::VulkanSwapchain::freeSwapchain()
{
...
ng::vulkan::SwapchainSupportDetails ng::vulkan::VulkanSwapchain::querySwapchainSupport()
{
