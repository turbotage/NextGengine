...
void run() {
	...
	ngv::VulkanShaderModule vert{ device.device(), shaderPath + "/triangle/helloTriangle.vert.spv" };
	ngv::VulkanShaderModule frag{ device.device(), shaderPath + "/triangle/helloTriangle.frag.spv" };
